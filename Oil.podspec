#
#  Be sure to run `pod spec lint Oil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Marcel Bradea" => "mbradea@gmail.com" }
  # Or just: s.author    = "Marcel Bradea"
  # s.authors            = { "Marcel Bradea" => "mbradea@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Marcel Bradea"
  ...
  s.source       = { :git => "https://github.com/TheNestOrg/Oil-iOS.git", :tag => "#{s.version}" }
